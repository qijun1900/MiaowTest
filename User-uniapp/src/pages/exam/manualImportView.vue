        ...
        <view class="content">
            ...
            <view class="question-type-component">
                ...
                <view
                    ...
                    :class="{
                        'fade-slide-in': selectedQuestionTypeValue === 1,
                    }"
                >
                    <AddSelect
                        :currentBankId="questionbankId"
                        :isEdit="isEditMode"
                ...
                <view
                    ...
                    class="component-wrapper"
                    :class="{
                        'fade-slide-in': selectedQuestionTypeValue === 2,
                    }"
                >
                    <AddBlank
                        :currentBankId="questionbankId"
                ...
                <view
                    ...
                    class="component-wrapper"
                    :class="{
                        'fade-slide-in': selectedQuestionTypeValue === 3,
                    }"
                >
                    <AddJudge
                        :currentBankId="questionbankId"
                ...
                <view
                    ...
                    class="component-wrapper"
                    :class="{
                        'fade-slide-in': selectedQuestionTypeValue === 4,
                    }"
                >
                    <AddShort
                        :currentBankId="questionbankId"
