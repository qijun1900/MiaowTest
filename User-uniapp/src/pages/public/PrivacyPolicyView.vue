        ...
        <view class="content">
            <view class="section">
                <text class="section-title"
                    >本指引是题喵喵小程序开发者
                    （以下简称"开发者"）为处理你的个人信息而制定。</text
                >
            </view>

            <view class="section">
                <text class="section-header">开发者处理的信息</text>
                <text class="section-content"
                    >根据法律规定，开发者仅处理实现小程序功能所必要的信息。</text
                >
            </view>

            <view class="section">
                <text class="section-header"
                    >开发者将在获取你的明示同意后，收集你的手机号，用途是【在必要时和用户联系】</text
                >
            </view>

            <view class="section">
                <text class="section-header"
                    >开发者收集你的邮箱，用于在必要时和用户联系。</text
                >
            </view>

            <view class="section">
                <text class="section-header">未成年人保护</text>
                <text class="section-content">
            ...
            <view class="section">
                <text class="section-header">你的权益</text>
                <text class="section-content">
                ...
                <text class="contact-info">电话: 18756810208</text>
            </view>

            <view class="section">
                <text class="section-header">开发者对信息的存储</text>
                <text class="section-content">
            ...
            <view class="section">
                <text class="section-header">信息的使用规则</text>
                <text class="section-content">
            ...
            <view class="section">
                <text class="section-header">信息对外提供</text>
                <text class="section-content">
            ...
            <view class="section">
                <text class="update-date">更新日期：2025-11-22</text>
            </view>
