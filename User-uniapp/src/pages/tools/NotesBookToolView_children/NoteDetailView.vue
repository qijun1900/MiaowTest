        ...
        <view class="nav-row" :style="navRowStyle">
          ...
          <view class="nav-right">
            <view class="nav-action" @click="handleEdit">
              <uni-icons type="compose" size="15" color="#5f6779"></uni-icons>
            </view>
            <view class="nav-action danger" @click="handleDelete">
              <uni-icons type="trash" size="15" color="#9f5a5a"></uni-icons>
            </view>
          </view>
        </view>
      </view>
    ...
    <scroll-view class="detail-scroll" scroll-y>
      <view class="detail-body">
        ...
        <view v-else-if="loadError" class="empty-state">
          <uni-icons type="info" size="30" color="#b3b9c9"></uni-icons>
        ...
        <template v-else>
          <view class="content-card">
            ...
            <view class="meta-wrap">
              ...
              <text class="meta-text">{{ detailState.dateText }}</text>
              <text class="meta-divider">·</text>
              <text class="meta-text">{{ contentLength }} 字</text>
            </view>

            <view class="divider"></view>

            <rich-text class="detail-rich" :nodes="detailHtml"></rich-text>
          </view>
