            ...
            <view class="current-book-card">
                ...
                <view class="current-content" v-if="currentBook">
                    ...
                    <view class="current-book-info">
                        <text class="current-book-title">{{
                            currentBook.title || "未选择词书"
                        }}</text>
            ...
            <view class="setting-card">
                ...
                <view class="book-selector">
                    <scroll-view scroll-y class="book-list">
                        ...
                        <view
                            v-if="wordBooks.length === 0 && loading === false"
                            class="empty-state"
                        >
                            <image
                                class="empty-image"
...
const LoadCurrentBook = () => {
    if (wordBook_id.value) {
        currentBook.value = wordBooks.value.find(
            (book) => book._id === wordBook_id.value,
        );
    }
};
