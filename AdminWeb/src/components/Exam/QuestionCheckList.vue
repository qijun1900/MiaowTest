  ...
  <div>
    <el-card>
      <div class="header-container">
        ...
        <div class="header-right">
          ...
          <el-button type="primary" plain @click="handleRefresh"> 刷新数据 </el-button>
        </div>
      </div>
      <el-table
      ...
      >
        ...
        <el-table-column label="题目题干" width="200" :show-overflow-tooltip="true">
        ...
        <el-table-column label="操作">
          <template #default="scope">
            <el-button type="success" plain @click="handlePreview(scope.row)"> 预览题目 </el-button>
            <el-button type="primary" plain @click="handleEdit(scope.row)"> 编辑题目 </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      <template #dialogcontent>
        <component :is="currentComponent" :Data="QuestionData" :isEdit="isEditMode" />
      </template>
    </Dialog>
  </div>
</template>
...
import {
  FetchCheckQuestionList,
  FetchMatchQuestionList,
  RemoveUserList,
} from "@/API/Exam/usersQusetionAPI";
...
// 监听props变化，变化时重新请求数据
watch(
  [() => props.QuestionTitleId, () => props.examId],
  () => {
