<template>
  <div>
              ...
              <div class="edit-btn">
                <el-row :gutter="20" type="flex" justify="space-between" align="middle">
                  <el-col :xs="24" :sm="24" :md="18" :lg="18" :xl="18" class="left-buttons">
                    <el-button type="success" plain @click="handleAdd"> 增加题型 </el-button>
    ...
    <div class="eidt-card">
      ...
      >
        ...
        <el-table-column label="操作" fixed="right" min-width="280">
          <template #default="scope">
            <el-button type="success" plain @click="handleCheck(scope.row)">
              查看题目<el-icon><View /></el-icon>
            </el-button>
            <el-button type="success" plain @click="handleChooseQuestionType(scope.row)">
      ...
      <template #dialogcontent>
        <el-form ref="FormRef" :model="Form" :rules="Formrules">
          <el-form-item label="题型名称" prop="content">
            <el-input v-model="Form.content" placeholder="请输入题型名称" />
          </el-form-item>
    ...
    <Drawer v-model="drawerVisible1" drawerTitle="选择题目类型" drawerSize="30%">
    ...
    <Drawer v-model="drawerVisible2" drawerTitle="添加题目" drawerSize="50%">
      <template #drawercontent>
        <QuestionAddList
    ...
    <Drawer v-model="drawerVisible3" drawerTitle="题目列表" drawerSize="50%">
      <template #drawercontent>
        <QuestionCheckList :QuestionTitleId="QuestionTitleId" :examId="route.params.id" />
      </template>
    </Drawer>
  </div>
</template>
