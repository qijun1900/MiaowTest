<template>
  <div class="consumer-message-container">
    ...
    <el-card class="table-card" shadow="never">
      ...
      <el-table height="440" :data="filteredFeedbackList" v-loading="loading" stripe>
          ...
          <template #default="{ row }">
            <div class="user-info">
              ...
              <div class="user-details">
                <div class="username">
                  {{ row.uid || "匿名用户" }}
                  <el-tag v-if="row.uid" size="small" type="success" effect="plain">
                    已登录
                  </el-tag>
        ...
        <el-table-column label="操作" width="200" align="center" fixed="right">
          <template #default="{ row }">
            ...
            <Popconfirm title="您确定删除吗？" @confirm="handleDelete(row)">
          ...
          <el-descriptions-item label="用户信息">
            <div class="detail-user-info">
              ...
              <div class="user-text">
                ...
                <el-tag size="small" :type="currentFeedback.uid ? 'success' : 'info'">
