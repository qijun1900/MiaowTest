    ...
    <div class="edit-table">
      ...
      >
        ...
        <el-table-column label="信息内容" width="190">
          <template #default="scope">
            <el-button plain type="info" @click="handleLooked(scope.row.content)"
              >{{ scope.row.category == 1 ? "公告" : "通知" }}内容</el-button
            >
          </template>
        </el-table-column>
      ...
      <template #dialogcontent>
        <el-form ref="FormRef" :model="Form" :rules="Formrules">
          ...
          <el-form-item label="类别" prop="category">
            <el-select v-model="Form.category" placeholder="Select" style="width: 280px">
              <el-option
