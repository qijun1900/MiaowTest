    ...
    <div class="edit-table">
      ...
      >
        ...
        <el-table-column label="单词数量" width="120" prop="words" sortable>
          <template #default="scope">
            <el-statistic :value="scope.row.words" :precision="0" class="statistic-item">
              <template #suffix>
        ...
        <el-table-column label="背诵人数" width="140" prop="reciteCount" sortable>
          <template #default="scope">
            <el-statistic :value="scope.row.reciteCount" :precision="0" class="statistic-item">
              <template #prefix>
      ...
      <template #dialogcontent>
        ...
        >
          <el-form-item label="书籍ID" prop="bookId">
            <el-input v-model="bookForm.bookId" placeholder="书籍ID" disabled />
          </el-form-item>

          <el-form-item label="书籍名称" prop="title">
            <el-input v-model="bookForm.title" placeholder="请输入书籍名称" />
          </el-form-item>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-form-item label="单词数量" prop="words">
                <el-input-number v-model="bookForm.words" :min="0" :step="1" style="width: 100%" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
