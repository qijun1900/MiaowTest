<template>
  <div>
        ...
        <el-card shadow="hover" class="quick-card">
          <div class="card-content">
            ...
            <div class="card-body">
              ...
              <el-button type="primary" class="card-button" @click="handleAddUser">
                点击添加
              </el-button>
            </div>
          </div>
        ...
        <el-card shadow="hover" class="quick-card">
          <div class="card-content">
            ...
            <div class="card-body">
              ...
              <el-button type="primary" class="card-button" @click="handleCheeckAnnouncement"
                >查看详情</el-button
              >
            </div>
          </div>
        ...
        <el-card shadow="hover" class="quick-card">
          <div class="card-content">
            ...
            <div class="card-body">
              ...
              <el-button type="primary" class="card-button" @click="handleCheeckExam"
                >查看详情</el-button
              >
            </div>
          </div>
        ...
        <el-card shadow="hover" class="quick-card">
          <div class="card-content">
            ...
            <div class="card-body">
              ...
              <el-button type="primary" class="card-button" @click="handleCheeckMessage"
                >查看消息</el-button
              >
            </div>
          </div>
    ...
    <el-row :gutter="20">
      <el-col :span="10"
        ><el-card shadow="hover"><BarChart /></el-card
      ></el-col>
      <el-col :span="14"
        ><el-card shadow="hover"><PieChart /></el-card
      ></el-col>
    </el-row>
  </div>
</template>
