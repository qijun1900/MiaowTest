        ...
        <div class="edit-btn">
          <el-row :gutter="20" type="flex" justify="space-between" align="middle">
            <el-col :xs="24" :sm="24" :md="18" :lg="18" :xl="18" class="left-buttons">
              <el-button type="success" plain @click="handleAdd">新建科目 </el-button>
              <Popconfirm
    ...
    <div class="edit-table">
      ...
      >
        ...
        <el-table-column label="科目代码" width="140">
          <template #default="scope">
            <el-button plain type="info" @click="handleLooked(scope.row.code)">科目代码</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" fixed="right" min-width="380">
          <template #default="scope">
            ...
            >
              <el-button type="danger" plain :loading="isDeleting"> 删除 </el-button>
            </Popconfirm>
            <el-button type="success" plain @click="handleEdit(scope.row)"> 仪表盘 </el-button>
            <el-button color="#626aef" type="info" plain @click="handleCreate(scope.row)">
              考试/资料
    ...
    <template #dialogcontent>
      ...
      >
        ...
        <el-form-item label="开考时间" prop="day">
          <el-date-picker v-model="subjectForm.day" type="date" placeholder="选择考试时间" />
        </el-form-item>
...
const handleCheckQuestion = (data, category) => {
  RouterPush(`/exam/questionlist/${data._id}`, { category });
...
const handleCreate = (data) => {
  RouterPush(`/exam/createExamType/${data._id}`);
  appStore.changeExamInfo({
    ...data,
  });
};
