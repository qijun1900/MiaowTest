  ...
  <div>
              ...
              <div class="edit-btn">
                <el-row :gutter="20" type="flex" justify="space-between" align="middle">
                  <el-col :xs="24" :sm="24" :md="18" :lg="18" :xl="18" class="left-buttons">
                    <el-button type="success" plain @click="handleAdd"> 添加题目 </el-button>
                    <el-button
                      type="primary"
                      plain
    ...
    <div class="eidt-card">
      ...
      >
        ...
        <el-table-column label="题目题干" width="250" :show-overflow-tooltip="true">
        ...
        <el-table-column label="是否为AI答案" width="150">
          <template #default="scope">
            <el-tag :type="scope.row.isAIanswer === 1 ? 'warning' : 'info'" size="small">
