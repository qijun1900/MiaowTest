...
const FileService = {
  ...
  getTags: async () => {
    try {
      ...
      console.error(
        "ERROR:database Type: FileService 获取业务标签数组失败:",
        error,
      );
      throw error;
    }
  ...
  getFileList: async ({ page, size, search, tag }) => {
    try {
      ...
      console.error(
        "ERROR:database Type: FileService 获取资源列表失败:",
        error,
      );
      throw error;
    }
  ...
  deleteFile: async (fileId) => {
    try {
      ...
      console.error(
        "ERROR:database Type: FileService 删除文件资源失败:",
        error,
      );
      throw error;
    }
  ...
  updateFile: async (fileId, updateData, isUpdatedFile) => {
    try {
      ...
      console.error(
        "ERROR:database Type: FileService 更新文件资源失败:",
        error,
      );
      throw error;
    }
  ...
  changeFileStatus: async (fileId) => {
    try {
      ...
      console.error(
        "ERROR:database Type: FileService 更改文件资源状态失败:",
        error,
      );
      throw error;
    }
