...
async function startMigration() {
  ...
  try {
    ...
    console.log(
      `avataruploads 目录迁移完成，共迁移 ${avatarResults.length} 个文件`,
    );
    ...
    console.log(
      `examcoveruploads 目录迁移完成，共迁移 ${examCoverResults.length} 个文件`,
    );
    ...
    console.log(
      `newsuploads 目录迁移完成，共迁移 ${newsResults.length} 个文件`,
    );
    ...
    console.log(
      `productuploads 目录迁移完成，共迁移 ${productResults.length} 个文件`,
    );
    ...
    console.log(
      `stylesheets 目录迁移完成，共迁移 ${stylesheetResults.length} 个文件`,
    );
